...
#import "EasyPermissionNet.h"
#import "NetReachability.h"
#import "EasyPermissionData.h"

@interface EasyPermissionNet()
...
@implementation EasyPermissionNet

+ (instancetype)sharedManager
{
    static EasyPermissionNet* _sharedInstance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedInstance = [[EasyPermissionNet alloc] init];
...
- (void)listenNetPermisson
{
    ...
    dispatch_once(&onceToken, ^{
        ...
        [EasyPermissionData authorizeWithCompletion:^(BOOL granted, BOOL firstTime)
         {
