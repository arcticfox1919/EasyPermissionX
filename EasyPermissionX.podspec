...
Pod::Spec.new do |s|
  ...
  s.version      = '0.0.2'
  s.summary      = 'An easy permission library for iOS.'
  ...
  s.homepage     = 'https://github.com/arcticfox1919/EasyPermissionX'
  ...
  s.source       = { :git => 'https://github.com/arcticfox1919/EasyPermissionX.git', :tag => "#{s.version}" }
  s.requires_arc = true
